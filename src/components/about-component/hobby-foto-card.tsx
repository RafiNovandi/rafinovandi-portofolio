...
export default function HobbyFotoCard() {
  return (
    <div className="relative flex justify-center group items-center w-full min-h-140 overflow-hidden group">
      <img
        className="absolute -translate-x-115 -translate-y-34 max-md:hidden"
        src={iconLeft.src}
        alt="Icon Left"
      />
      ...
      <div className="h-80 w-full max-w-80 rounded-4xl p-4 bg-white max-md:max-w-60 max-md:h-60 max-md:p-3 drop-shadow-[0_25px_50px_rgba(0,0,0,0.10)]">
        <img
          className="w-full h-full rounded-xl"
          src={kucingPic.src}
          alt="Foto Kucing"
      ...
      <img
        className="absolute translate-x-100 translate-y-60 max-md:hidden"
        src={iconRight.src}
        alt="Icon Right"
      />
    </div>
